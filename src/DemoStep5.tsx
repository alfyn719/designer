...
const UserManagementSchema = {
  ...
  properties: {
    ...
    onAddUser: {
      'description':
        'Callback function for adding a user. Accepts an object with name, gender, age, and optional isVip.',
      'type': 'object',
      'x-functional': true,
    },
    onUpdateUser: {
      'description':
        'Callback function for updating a user. Accepts the user and a partial update object.',
      'type': 'object',
      'x-functional': true,
    },
    onDeleteUser: {
      'description': 'Callback function for deleting a user. Accepts the user object.',
      'type': 'object',
      'x-functional': true,
    },
    onFilter: {
      'description': 'Callback function for filtering users. Accepts filter values.',
      'type': 'object',
      'x-functional': true,
    },
    onMounted: {
      'description': 'Optional callback invoked when the component mounts.',
      'type': 'object',
      'x-functional': true,
    },
    onUnmounted: {
      'description': 'Optional callback invoked when the component unmounts.',
      'type': 'object',
      'x-functional': true,
    },
  },
  required: ['users', 'onAddUser', 'onUpdateUser', 'onDeleteUser', 'onFilter'],
}

// Attach the JSON Schema to the component for external usage
UserManagement.schema = UserManagementSchema
